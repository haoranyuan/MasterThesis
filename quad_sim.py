import quadcopter_2d,gui,controller
import signal
import sys
import argparse
...
def Single_Point2Point():
    ...
    QUADCOPTER={'q1':{'position':[1,1,4],'orientation':[0,0,0],'L':0.3,'r':0.1,'prop_size':[10,4.5],'weight':1.2}}
    ...
    quad = quadcopter_2d.Quadcopter(QUADCOPTER)
...
def Multi_Point2Point():
    ...
    quad = quadcopter_2d.Quadcopter(quads=QUADCOPTERS)
...
def parse_args():
    ...
    parser.add_argument("--controller_update_time", type=float, default=0.005, help='delta time for controller update(seconds), ex: --controller_update_time 0.005')
