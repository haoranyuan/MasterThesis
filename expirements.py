...
demo_file = 'AL_results/projection_good_08noise/demodata.csv'
DIR_ = 'AL_results/projection_good_08noise/'
REPEAT = 10
ITER = 20
for ij in tqdm(range(REPEAT)):
    ii = ij + 0
    DIR = DIR_ + 'projection_good_08noise'+str(ii) + '/'
    os.mkdir(DIR_ + 'projection_good_08noise' + str(ii))
